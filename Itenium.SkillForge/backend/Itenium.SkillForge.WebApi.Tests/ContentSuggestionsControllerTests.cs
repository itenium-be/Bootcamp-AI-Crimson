...
public class ContentSuggestionsControllerTests : DatabaseTestBase
{
    ...
    {
        Db.ContentSuggestions.Add(new ContentSuggestionEntity { SubmittedBy = "user-1", Title = "Mine" });
        Db.ContentSuggestions.Add(new ContentSuggestionEntity { SubmittedBy = "user-2", Title = "Not Mine" });
    ...
    public async Task GetMySuggestions_OrderedBySubmittedAtDescending()
    {
        ...
        Db.ContentSuggestions.Add(new ContentSuggestionEntity { SubmittedBy = "user-1", Title = "Old", SubmittedAt = old });
        Db.ContentSuggestions.Add(new ContentSuggestionEntity { SubmittedBy = "user-1", Title = "Recent", SubmittedAt = recent });
        await Db.SaveChangesAsync();
